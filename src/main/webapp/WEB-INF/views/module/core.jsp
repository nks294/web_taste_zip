<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <!-- 전체 스타일 -->
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/mobile.css">
        <!-- 미디어쿼리 -->
        ...
        <script type="text/javascript"
            src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=7d0b93d4daafc27bea0f6f9037b0e730&libraries=services"></script>

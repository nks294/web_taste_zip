...
<html lang="ko">
    ...
    <!-- 메인화면 JS -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/home.js?v=<%=System.currentTimeMillis()%>"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/mainBanner.js?v=<%=System.currentTimeMillis()%>"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/mapSmall.js?v=<%=System.currentTimeMillis()%>"></script>
        ...
        <section id="main-banner" class="com-margin-0 com-width-100">
            <div class="main-banner-wrapper com-relative com-overflow-hidden">
                <div class="banner-slides">
                    <a href="${pageContext.request.contextPath}/tastezip/notice/4"><img src="${pageContext.request.contextPath}/resources/img/example/example_image_01.jpg" alt="이번주 리뷰왕은 누구?" data-link="/tastezip/notice/4" data-title="이번주 리뷰왕은 누구?"></a>
                    <a href="${pageContext.request.contextPath}/tastezip/notice/5"><img src="${pageContext.request.contextPath}/resources/img/example/example_image_02.jpg" alt="나만의 마커 커스터마이징 오픈!" data-link="/tastezip/notice/5" data-title="나만의 마커 커스터마이징 오픈!"></a>
                    <a href="${pageContext.request.contextPath}/tastezip/notice/6"><img src="${pageContext.request.contextPath}/resources/img/example/example_image_03.jpg" alt="이번달의 맛.zip 테마: #흑백요리사" data-link="/tastezip/notice/6" data-title="이번달의 맛.zip 테마: #흑백요리사"></a>
                    <a href="${pageContext.request.contextPath}/tastezip/notice/7"><img src="${pageContext.request.contextPath}/resources/img/example/example_image_04.jpg" alt='"클린 리뷰" 캠페인' data-link="/tastezip/notice/7" data-title='"클린 리뷰" 캠페인'></a>
                    <a href="${pageContext.request.contextPath}/tastezip/notice/8"><img src="${pageContext.request.contextPath}/resources/img/example/example_image_05.jpg" alt="신상 아이콘 4종 등장!" data-link="/tastezip/notice/8" data-title="신상 아이콘 4종 등장!"></a>
                </div>

        ...
        <main id="notice" class="com-flex-row com-flex-justify-center com-gap-40">
            ...
            <section id="board" class="notice-area com-flex-1 com-margin-0">
                <div class="board-header com-flex-row com-flex-justify-spacebetween com-flex-align-center com-margin-bottom-50">
                    ...
                    <form action="${pageContext.request.contextPath}/notice" method="get" class="com-flex-row com-gap-20">
                ...
                <div class="board-contents">
                    <div class="tabs">
                        <ul class="com-flex-row com-font-size-5">
                            <li class="${category eq 'all' ? 'active' : ''} com-width-100 com-inline-flex"><a href="${pageContext.request.contextPath}/notice?category=all" class="com-width-100 com-border-bottom-bold com-text-center com-padding-4">전체</a></li>
                            <li class="${category eq 'notice' ? 'active' : ''} com-width-100 com-inline-flex"><a href="${pageContext.request.contextPath}/notice?category=notice" class="com-width-100 com-border-bottom-bold com-text-center com-padding-4">공지</a></li>
                            <li class="${category eq 'update' ? 'active' : ''} com-width-100 com-inline-flex"><a href="${pageContext.request.contextPath}/notice?category=update" class="com-width-100 com-border-bottom-bold com-text-center com-padding-4">뉴스</a></li>
                            <li class="${category eq 'event' ? 'active' : ''} com-width-100 com-inline-flex"><a href="${pageContext.request.contextPath}/notice?category=event" class="com-width-100 com-border-bottom-bold com-text-center com-padding-4">이벤트</a></li>
                        </ul>
                    </div>
                                    ...
                                    <c:forEach var="board" items="${boardList}">
                                        <li class="com-width-100 com-padding-list-big com-flex-row com-flex-align-center com-flex-justify-spacebetween com-border-bottom-thin com-margin-bottom-10">
                                            <div class="board-title com-font-size-5">
                                                <a href="${pageContext.request.contextPath}/notice/${board.boardId}">
                                                    ${board.title}
                                                </a>
                                            </div>
                        ...
                        <div class="pagination com-flex-row com-flex-justify-center com-flex-align-center com-gap-30">
                            <c:if test="${totalPages > 1}">
                                <c:if test="${currentPage > 1}">
                                    <a href="${pageContext.request.contextPath}/notice?category=${category}&page=${currentPage - 1}" class="page-link com-padding-1 com-font-size-3 com-font-normal com-color com-pointer">이전</a>
                                </c:if>
                                ...
                                <c:forEach var="i" begin="1" end="${totalPages}">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a href="${pageContext.request.contextPath}/notice?category=${category}&page=${i}" class="page-link com-padding-1 com-font-size-3 com-font-normal com-color com-pointer">${i}</a>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            
                                <c:if test="${currentPage < totalPages}">
                                    <a href="${pageContext.request.contextPath}/notice?category=${category}&page=${currentPage + 1}" class="page-link com-padding-1 com-font-size-3 com-font-normal com-color com-pointer">다음</a>
                                </c:if>
                            </c:if>
                        </div>
                    </div>
